...
public class Project_details extends BaseClass {

	@Test(groups = {"AllTest","Project_details"})
	public void check_fun_ProjectDetails()
	{
		...
		//click on Project Details sub-module
		System.out.println("Clicking on Project Details");
		driver.findElement(By.xpath("//li[@class='nav-sub-item']/a[@title='Project Details']")).click();
		
		Utilities.hardWait(3);
		
		//Click on Add new Project Details button
		driver.findElement(By.xpath("//a[@tooltip='Add New Project Details']/i[@class='fa fa-plus-circle fa-fw']")).click();
		...
		//Project Name
		driver.findElement(By.id("projectName")).sendKeys("Baby Accounting");
		
		Utilities.hardWait(3);
		
		//Project Code
		driver.findElement(By.id("projctCode")).sendKeys("231565");
		...
		//Project Type
		driver.findElement(By.xpath("//div[@id='project_type_chosen']")).click();
		Utilities.hardWait(5);
		
		driver.findElement(By.xpath("//li[contains(text(),'Commercial Development')]")).click();
		Utilities.hardWait(3);
		
		//Rate per Unit
		driver.findElement(By.id("ratePerUnit")).sendKeys("8");
		Utilities.hardWait(3);
		
		//VAT Percentage
		driver.findElement(By.id("vatTax")).sendKeys("64");
		Utilities.hardWait(3);
		
		//Prefix
		driver.findElement(By.xpath("//div[12]/div[1]/label[1]")).click();
		Utilities.hardWait(3);
