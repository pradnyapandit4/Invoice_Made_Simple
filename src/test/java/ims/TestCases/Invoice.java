...
public class Invoice extends BaseClass {
	...
	@Test(groups = {"AllTest","Invoice"})
	public void check_fun_Invoice()
	{
		...
		//click on Invoice sub-module
		System.out.println("Clicking on Invoice");
		driver.findElement(By.xpath("//li[@class='nav-sub-item']/a[@title='Invoice']")).click();
		
		Utilities.hardWait(3);
		
		//Click on Add new Invoice Details button
		driver.findElement(By.xpath("//a[@tooltip='Add New Invoice Details']/i[@class='fa fa-plus-circle fa-fw']")).click();
		...
		//Invoice Date
		WebElement invdate = driver.findElement(By.id("invoicedate"));
		invdate.click();
		Utilities.hardWait(5);
		...
		WebElement unit = driver.findElement(By.xpath("//div[9]/div[1]/div[1]/div[1]/ul[1]/li[4]"));
		unit.click();
		Utilities.hardWait(3);
		...
		//Description
		driver.findElement(By.id("invoice_desc")).sendKeys("Testing");		
		Utilities.hardWait(3);
		
		//Due Days
		driver.findElement(By.id("duedays")).sendKeys("6");
...
//		actions.sendKeys(Keys.ESCAPE).perform(); // Simulates pressing the Escape key (usually closes the alert)
		...
		driver.findElement(By.xpath("//div[@id='Inv_Status_chosen']")).click();
		Utilities.hardWait(5);
		
		driver.findElement(By.xpath("//li[contains(text(),'Adjusted')]")).click();
		Utilities.hardWait(3);
		
		driver.findElement(By.xpath("//button[@class='btn btn-sm btn-primary change_invoice_status form=']")).click();
