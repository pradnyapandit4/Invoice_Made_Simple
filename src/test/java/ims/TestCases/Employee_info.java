...
public class Employee_info extends BaseClass{

	@Test(groups = {"AllTest","Employee_info"})
	public void check_fun_EmployeeInfo()
	{
		...
		//click on Employee Info sub-module
		System.out.println("Clicking on Employee Info");
		driver.findElement(By.xpath("//li[@class='nav-sub-item']/a[@title='Employee Info']")).click();
